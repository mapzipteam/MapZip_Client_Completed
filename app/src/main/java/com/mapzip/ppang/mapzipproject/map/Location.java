...
public class Location {
    ...
    ///11.���빮�� �߽���ǥ �浵(LNG), ����(LAT), NGeoPoint ��ǥ
    ...
    ///12.���۱� �߽���ǥ �浵(LNG), ����(LAT), NGeoPoint ��ǥ
    ...
    ///14.���빮�� �߽���ǥ �浵(LNG), ����(LAT), NGeoPoint ��ǥ
    ...
    ///15.���ʱ� �߽���ǥ �浵(LNG), ����(LAT), NGeoPoint ��ǥ
    ...
    ///17.���ϱ� �߽���ǥ �浵(LNG), ����(LAT), NGeoPoint ��ǥ
    ...
    ///18.���ı� �߽���ǥ �浵(LNG), ����(LAT), NGeoPoint ��ǥ
    ...
    ///19.��õ�� �߽���ǥ �浵(LNG), ����(LAT), NGeoPoint ��ǥ
    ...
    ///21.��걸 �߽���ǥ �浵(LNG), ����(LAT), NGeoPoint ��ǥ
    ...
    ///23.���α� �߽���ǥ �浵(LNG), ����(LAT), NGeoPoint ��ǥ
    ...
    ///24.�߱� �߽���ǥ �浵(LNG), ����(LAT), NGeoPoint ��ǥ
